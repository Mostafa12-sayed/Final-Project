...
class ProductFactory extends Factory
{
    ...
    public function definition()
    {
        ...
        $mainImage = $this->faker->randomElement([
        ...
        // Define the gallery, starting with the main image
        $galleryImages = [
            $mainImage, // First image is the same as $product->image
            ...$this->faker->randomElements([
                ...
                'assets/img/product/09.png',
                'assets/img/product/10.png',
            ], 2, false), // Add 2 more random images
        ];
        return [
            'name'        => $name,
